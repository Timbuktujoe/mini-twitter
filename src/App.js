...
function App() {
  ...
  return (
    <div className="App">
     <Switch>
     <Route exact path="/">  <Sidebar component={<Col xs={12} md={6} ><Messages userData={userData} messages={messages} setUserData={setUserData} /></Col>} userData={userData} setUserData={setUserData} /> </Route>  
